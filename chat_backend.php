<?php
// chat_backend.php - Chat avanzado con soporte multimedia y perfiles protegidos
session_start();
...
// Acción: Obtener y renderizar los mensajes (últimos 50 de forma cronológica)[cite: 7]
$stmt_chat = $db->query("
...
while ($msg = $stmt_chat->fetch(PDO::FETCH_ASSOC)) {
    ...
    // Encabezado del mensaje con Hash público y opción de auditoría de perfil[cite: 7]
