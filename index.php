            ...
            <?php elseif ($action === 'consultation'): ?>
                <div class="glass-card" style="margin: 0 auto; width: 100%;">
                    ...
                    <form action="?view=consultation" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Adjuntar Archivo de Soporte </label>
                ...
                <div class="glass-card" style="margin: 0 auto; width: 100%;">
                   <div class="badge-status">Recuperación Criptográfica</div>
                    ...
                    <form action="?view=recover" method="POST">
                        ...
                        <button type="submit" class="btn btn-warning" style="width: 100%; margin-top: 1rem;">Validar Hash </button>
                    </form>
                </div>
            ...
            <?php elseif ($action === 'profile'): ?>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; width: 100%; max-width: 1100px; margin: 2rem auto;">
                            ...
                            <div style="max-height: 450px; overflow-y: auto; display: flex; flex-direction: column; gap: 1rem;">
                                ...
                                ?>
                                    <div id="consultation-item-<?php echo $c['id']; ?>" style="background: rgba(3,7,18,0.8); padding: 1rem; border-radius: 6px; border: 1px solid rgba(255,255,255,0.1); position:relative;">
                                        ...
                                        <!-- Visualizador de Archivos Adjuntos del Usuario con enlace seguro -->
                                        <?php if (!empty($c['user_file_path']) && file_exists(__DIR__ . '/' . $c['user_file_path'])): ?>
                                            <div style="margin-top: 0.5rem; padding: 0.5rem; background: rgba(6, 182, 212, 0.1); border: 1px dashed var(--theme-color); border-radius: 4px; display: flex; align-items: center; justify-content: space-between;">
                                                <span style="font-size: 0.8rem; color: var(--theme-color);">
                                                    📎 Archivo adjunto: <strong><?php echo htmlspecialchars($c['user_file_name']); ?></strong>
                                                </span>
                                                <a href="<?php echo htmlspecialchars($c['user_file_path']); ?>" target="_blank" class="btn btn-outline" style="padding: 0.2rem 0.6rem; font-size: 0.75rem;">
                    ...
                    <div class="glass-card" style="max-width: 100%;">
                        ...
                        <h3 style="font-family: 'Orbitron'; color: #ef4444; margin-bottom: 1rem;"> Desactivar / Eliminar Cuenta </h3>
                        <div style="display: flex; gap: 1rem;">
                        ...
                        <form onsubmit="enviarMensajeMultimedia(event)" style="display: flex; flex-direction: column; gap: 0.8rem;">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; font-size: 0.8rem; background: rgba(0,0,0,0.3); padding: 6px 10px; border-radius: 6px;">
                                ...
                                <div>
                                    <button type="button" id="record-btn" onclick="toggleGrabarAudio()" class="btn btn-outline" style="font-size: 0.75rem; padding: 0.3rem 0.6rem; border-color: #ef4444; color: #ef4444;"> Grabar Voz</button>
