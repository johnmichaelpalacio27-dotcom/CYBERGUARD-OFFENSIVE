<?php dame todo este codigo igual pero dame en el inicio el registro para un solo admisnistrador y le agregas proteccion y en la parte de admisnitradcion poder administrar en el perfil , envios de conslutas que realizan los usuarios y llegue el pefil del administrador y asi en el pefil de los usuairos le pones a que puedan responder y recibir los mensajes y enviar al administrador por correo y llegue via web al correo del admisntrador y asi mensajes a otros usuarios 
